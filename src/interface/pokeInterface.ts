...
export class Convert {
    public static toPokeDetails(json: string): PokeDetails {
        return cast(JSON.parse(json), r("PokeDetails"));
    }

    public static pokeDetailsToJson(value: PokeDetails): string {
        return JSON.stringify(uncast(value, r("PokeDetails")), null, 2);
    }
}
